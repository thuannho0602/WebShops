...
{
    public class ManageProductServise : IManageProductService
    {
        private readonly DemoDbcontext _context;
        private readonly IStorageService _storageService;

        public ManageProductServise(DemoDbcontext context, IStorageService storageService)
        {
            _context = context;
        ...
        public async Task<ProductImageViewModel> GetImageById(int imageId)
        {
            ...
            if (image == null)
                throw new WebShopExceptions($"Cannot find an image with id {imageId}");
        ...
        public async Task<int> Update(ProductUpdateRequest request)
        {
            ...
            if (product == null || productTranslations == null) throw new WebShopExceptions($"Cannot find a product with id: {request.Id}");
